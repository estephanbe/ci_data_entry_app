        ...
        <div class="col-12 col-md-6 order-1 order-md-0 d-flex justify-content-center align-items-center justify-content-md-start mb-5">
            <form class="w-75">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="co-name" name="co-name">
                </div>
                <div class="mb-3">
                    <label for="co-country" class="form-label">البلد</label>
                    <input type="text" class="form-control" id="co-country" name="co-country">
                </div>
                <div class="mb-3">
                    <label for="co-nationality" class="form-label">الجنسية</label>
                    <input type="text" class="form-control" id="co-nationality" name="co-nationality">
                </div>
                <div class="mb-3">
                    <label for="co-occupation" class="form-label">المهنة</label>
                    <input type="text" class="form-control" id="co-occupation" name="co-occupation">
                </div>
                <div class="mb-5">
                    <label for="co-photo" class="form-label">الصورة</label>
                    <input class="form-control form-control-lg" id="co-photo" name="co-photo" type="file" onchange="readURL(this);">
                </div>
